...
class MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.configButton.setGeometry(QtCore.QRect(440, 10, 220, 35))
        self.configButton.setMaximumSize(QtCore.QSize(220, 35))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.monitorBrowser.setGeometry(QtCore.QRect(10, 150, 880, 310))
        font = QtGui.QFont()
        font.setPointSize(8)
