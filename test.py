import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QGroupBox, QPushButton, QLabel
...
if __name__ == '__main__':
    ...
    window = MainWindow()
    window.setGeometry(100, 100, 200, 200)  # set default window size to 200x200
